...
- 💬 Ask me about React / Next.js, smart contracts, or full-stack design!  

## 🔭 Current Projects
- **AI Legal Tool** – Document analyzer that detects bias, flags unfair clauses, and suggests improvements. (Python, Redis, Gemini API)  
- **PloughIt** – Blockchain-backed contract-farming marketplace with bidding and smart contracts. (Next.js, Solidity, Express)  
- **Content Sentinel** – Chrome extension to detect and mask harmful content on the web. (JavaScript, Readability, Gemini API)  
- **Sign2Text** – Real-time sign language to text converter using computer vision & Tkinter GUI. (Python, CNN, OpenCV)  
...
<table>
  ...
  <tr>
    ...
    <td align="center"><img src="https://img.shields.io/badge/Tailwind CSS-06B6D4?style=flat-square&logo=tailwind-css&logoColor=white"/></td>
